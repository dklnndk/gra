...
def CheckWinner():
    ...
    if winner ==1:
        messagebox.showinfo(title="Gratulacje!", 
            message="Gracz 1 wygrywa!")
    elif winner ==2:
        messagebox.showinfo(title="Gratulacje!", 
            message="Gracz 2 wygrywa!")
    elif mov ==9:
        messagebox.showinfo(title="Remis", 
            message="Jest remis!")
...
def ButtonClick(id):
    ...
    if(ActivePlayer ==1):
        ...
        p1.append(id)
        mov +=1
        root.title("Kółko i Krzyżyk : Gracz 2")
        ActivePlayer =2
...
Button(text="Nowa gra..", font=('Courier new', 22, 'bold'), bg='blue', fg='white',
